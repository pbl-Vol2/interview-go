          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-center mb-6">
                Do you want to apply the changes to your profile?
              </p>
              <div className="flex space-x-4 justify-center">
                <button
                  onClick={() => setIsOpen(false)}
                  className="bg-customBiru3 hover:bg-customBiru4 text-white font-semibold w-1/2 py-2 rounded"
                >
                  Cancel
                </button>
                <button
                  onClick={() => {
                    setIsOpen(false);
                    // Optionally add a function to apply changes here
                  }}
                  className="bg-customBiru3 hover:bg-customBiru4 text-white font-semibold w-1/2 py-2 rounded"
                >
                  Apply
